  ...
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <ol>
          <li>
            10 Get started by editing <code>src/app/page.tsx</code>.
          </li>
        ...
        <div className={styles.ctas}>
          ...
          >
            <Image className={styles.logo} src={getImage('/vercel.svg')} alt="Vercel logomark" width={20} height={20} />
            Deploy now
          </a>
          <a
      ...
      <footer className={styles.footer}>
        <a href="https://nextjs.org/learn?utm_source=create-next-app&utm_medium=appdir-template&utm_campaign=create-next-app" target="_blank" rel="noopener noreferrer">
          <Image aria-hidden src={getImage('/file.svg')} alt="File icon" width={16} height={16} />
          Learn
        </a>
        <a
          ...
          rel="noopener noreferrer"
        >
          <Image aria-hidden src={getImage('/window.svg')} alt="Window icon" width={16} height={16} />
          Examples
        </a>
        <a href="https://nextjs.org?utm_source=create-next-app&utm_medium=appdir-template&utm_campaign=create-next-app" target="_blank" rel="noopener noreferrer">
          <Image aria-hidden src={getImage('/globe.svg')} alt="Globe icon" width={16} height={16} />
          Go to nextjs.org →
        </a>
      </footer>
    </div>
